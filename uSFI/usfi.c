/*
 * uSFI Project
 * Implementation of uSFI interface functions  
 *
...
/* Data structures to store module configurations for each module.
* They reside in usfi data section
*/
...
{
	/* These values are obtained from the linker */
