...
end_of_check_HAL_UART_Init0:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_UART_Init.text.module.uart.ret:
...
end_of_check_HAL_UART_MspInit1:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_UART_MspInit.text.module.uart.ret:
...
end_of_check_HAL_HalfDuplex_Init3:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_HalfDuplex_Init.text.module.uart.ret:
...
end_of_check_HAL_LIN_Init4:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_LIN_Init.text.module.uart.ret:
...
end_of_check_HAL_MultiProcessor_Init5:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_MultiProcessor_Init.text.module.uart.ret:
...
end_of_check_HAL_UART_DeInit6:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_UART_DeInit.text.module.uart.ret:
...
end_of_check_HAL_UART_MspDeInit7:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_UART_MspDeInit.text.module.uart.ret:
...
end_of_check_HAL_UART_Transmit8:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_UART_Transmit.text.module.uart.ret:
...
end_of_check_HAL_UART_Receive10:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_UART_Receive.text.module.uart.ret:
...
end_of_check_HAL_UART_Transmit_IT11:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_UART_Transmit_IT.text.module.uart.ret:
...
end_of_check_HAL_UART_Receive_IT12:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_UART_Receive_IT.text.module.uart.ret:
...
end_of_check_HAL_UART_Transmit_DMA13:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_UART_Transmit_DMA.text.module.uart.ret:
...
end_of_check_HAL_UART_Receive_DMA17:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_UART_Receive_DMA.text.module.uart.ret:
...
end_of_check_HAL_UART_DMAPause20:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_UART_DMAPause.text.module.uart.ret:
...
end_of_check_HAL_UART_DMAResume21:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_UART_DMAResume.text.module.uart.ret:
...
end_of_check_HAL_UART_DMAStop22:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_UART_DMAStop.text.module.uart.ret:
...
@ BB#22:                                @ %if.then88
	...
	blcc exceptionFun
 	...
 	pop {r0}
	pop {lr}
boundcheckend.HAL_UART_IRQHandler.text.module.uart.indirect_1:
...
end_of_check_HAL_UART_IRQHandler25:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_UART_IRQHandler.text.module.uart.ret:
...
end_of_check_HAL_UART_ErrorCallback28:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_UART_ErrorCallback.text.module.uart.ret:
...
end_of_check_HAL_UART_TxCpltCallback31:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_UART_TxCpltCallback.text.module.uart.ret:
...
end_of_check_HAL_UART_TxHalfCpltCallback32:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_UART_TxHalfCpltCallback.text.module.uart.ret:
...
end_of_check_HAL_UART_RxCpltCallback33:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_UART_RxCpltCallback.text.module.uart.ret:
...
end_of_check_HAL_UART_RxHalfCpltCallback34:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_UART_RxHalfCpltCallback.text.module.uart.ret:
...
end_of_check_HAL_LIN_SendBreak35:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_LIN_SendBreak.text.module.uart.ret:
...
end_of_check_HAL_MultiProcessor_EnterMuteMode36:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_MultiProcessor_EnterMuteMode.text.module.uart.ret:
...
end_of_check_HAL_MultiProcessor_ExitMuteMode37:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_MultiProcessor_ExitMuteMode.text.module.uart.ret:
...
end_of_check_HAL_HalfDuplex_EnableTransmitter38:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_HalfDuplex_EnableTransmitter.text.module.uart.ret:
...
end_of_check_HAL_HalfDuplex_EnableReceiver39:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_HalfDuplex_EnableReceiver.text.module.uart.ret:
...
end_of_check_HAL_UART_GetState40:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_UART_GetState.text.module.uart.ret:
...
end_of_check_HAL_UART_GetError41:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_UART_GetError.text.module.uart.ret:
...
boundcheckstart.gateway.text.module.uart.ret:
	...
	blcc exceptionFun
 	...
 	blcs exceptionFun
 	pop {r0}
boundcheckend.gateway.text.module.uart.ret:
	 blx r4
...
end_of_check_UART_SetConfig2:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.UART_SetConfig.text.module.uart.ret:
...
end_of_check_UART_WaitOnFlagUntilTimeout9:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.UART_WaitOnFlagUntilTimeout.text.module.uart.ret:
...
end_of_check_UART_DMATransmitCplt14:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.UART_DMATransmitCplt.text.module.uart.ret:
...
end_of_check_UART_DMATxHalfCplt15:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.UART_DMATxHalfCplt.text.module.uart.ret:
...
end_of_check_UART_DMAError16:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.UART_DMAError.text.module.uart.ret:
...
end_of_check_UART_DMAReceiveCplt18:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.UART_DMAReceiveCplt.text.module.uart.ret:
...
end_of_check_UART_DMARxHalfCplt19:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.UART_DMARxHalfCplt.text.module.uart.ret:
...
end_of_check_UART_EndTxTransfer23:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.UART_EndTxTransfer.text.module.uart.ret:
...
end_of_check_UART_EndRxTransfer24:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.UART_EndRxTransfer.text.module.uart.ret:
...
end_of_check_UART_Receive_IT26:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.UART_Receive_IT.text.module.uart.ret:
...
end_of_check_UART_DMAAbortOnError27:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.UART_DMAAbortOnError.text.module.uart.ret:
...
end_of_check_UART_Transmit_IT29:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.UART_Transmit_IT.text.module.uart.ret:
...
end_of_check_UART_EndTransmit_IT30:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.UART_EndTransmit_IT.text.module.uart.ret:
...
end_of_check_HAL_DMA_Init0:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_DMA_Init.text.module.dma.ret:
...
end_of_check_HAL_DMA_DeInit3:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_DMA_DeInit.text.module.dma.ret:
...
end_of_check_HAL_DMA_Start4:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_DMA_Start.text.module.dma.ret:
...
end_of_check_HAL_DMA_Start_IT6:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_DMA_Start_IT.text.module.dma.ret:
...
end_of_check_HAL_DMA_Abort7:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_DMA_Abort.text.module.dma.ret:
...
end_of_check_HAL_DMA_Abort_IT8:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_DMA_Abort_IT.text.module.dma.ret:
...
end_of_check_HAL_DMA_PollForTransfer9:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_DMA_PollForTransfer.text.module.dma.ret:
...
@ BB#20:                                @ %if.then78
	...
	blcc exceptionFun
 	...
 	pop {r0}
	pop {lr}
boundcheckend.HAL_DMA_IRQHandler.text.module.dma.indirect_1:
...
@ BB#39:                                @ %if.then166
	...
	blcc exceptionFun
 	...
 	pop {r0}
	pop {lr}
boundcheckend.HAL_DMA_IRQHandler.text.module.dma.indirect_5:
...
@ BB#48:                                @ %if.then232
	...
	blcc exceptionFun
 	...
 	pop {r0}
	pop {lr}
boundcheckend.HAL_DMA_IRQHandler.text.module.dma.indirect_8:
...
end_of_check_HAL_DMA_IRQHandler10:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_DMA_IRQHandler.text.module.dma.ret:
...
end_of_check_HAL_DMA_RegisterCallback11:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_DMA_RegisterCallback.text.module.dma.ret:
...
end_of_check_HAL_DMA_UnRegisterCallback12:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_DMA_UnRegisterCallback.text.module.dma.ret:
...
end_of_check_HAL_DMA_GetState13:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_DMA_GetState.text.module.dma.ret:
...
end_of_check_HAL_DMA_GetError14:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_DMA_GetError.text.module.dma.ret:
...
boundcheckstart.gateway.text.module.dma.ret:
	...
	blcc exceptionFun
 	...
 	blcs exceptionFun
 	pop {r0}
boundcheckend.gateway.text.module.dma.ret:
	 blx r4
...
end_of_check_DMA_CheckFifoParam1:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.DMA_CheckFifoParam.text.module.dma.ret:
...
end_of_check_DMA_CalcBaseAndBitshift2:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.DMA_CalcBaseAndBitshift.text.module.dma.ret:
...
end_of_check_DMA_SetConfig5:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.DMA_SetConfig.text.module.dma.ret:
...
end_of_check_HAL_GPIO_Init0:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_GPIO_Init.text.module.gpio.ret:
...
end_of_check_HAL_GPIO_DeInit1:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_GPIO_DeInit.text.module.gpio.ret:
...
end_of_check_HAL_GPIO_ReadPin2:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_GPIO_ReadPin.text.module.gpio.ret:
...
end_of_check_HAL_GPIO_WritePin3:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_GPIO_WritePin.text.module.gpio.ret:
...
end_of_check_HAL_GPIO_TogglePin4:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_GPIO_TogglePin.text.module.gpio.ret:
...
end_of_check_HAL_GPIO_LockPin5:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_GPIO_LockPin.text.module.gpio.ret:
...
end_of_check_HAL_GPIO_EXTI_IRQHandler6:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_GPIO_EXTI_IRQHandler.text.module.gpio.ret:
...
end_of_check_HAL_GPIO_EXTI_Callback7:
	pop {r0}
 	orr lr,lr,#1
boundcheckend.HAL_GPIO_EXTI_Callback.text.module.gpio.ret:
...
boundcheckstart.gateway.text.module.gpio.ret:
	...
	blcc exceptionFun
 	...
 	blcs exceptionFun
 	pop {r0}
boundcheckend.gateway.text.module.gpio.ret:
	 blx r4
